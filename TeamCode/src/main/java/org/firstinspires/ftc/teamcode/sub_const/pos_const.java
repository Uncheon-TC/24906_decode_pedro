...
// RED CLOSE 18 Artifact
    public static Pose RED_CLOSE_START = new Pose(120.7, 122, Math.toRadians(37.5));
    public static Pose RED_CLOSE_ST_SHOOT = new Pose(109, 101, Math.toRadians(0));
...
// ==============================================================================
    ...
    // BLUE_CLOSE
    public static Pose BLUE_CLOSE_START = new Pose(24,122.5,Math.toRadians(140.8)); //24,122.5,140.8
    ...
    public static Pose BLUE_FAR_EAT_1 = RED_FAR_EAT_1.mirror();
    public static Pose BLUE_FAR_EAT_2 = RED_FAR_EAT_2.mirror();
    public static Pose BLUE_PARKING = RED_PARKING.mirror();
    public static Pose BLUE_FAR_EAT_2_CP = RED_FAR_EAT_2_CP.mirror();
