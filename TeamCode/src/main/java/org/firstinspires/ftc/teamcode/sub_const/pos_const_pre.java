...
public class pos_const_pre {
    ...
    public static Pose blue_eat_first = new Pose(15, 83, Math.toRadians(180));
    public static Pose blue_eat_second = new Pose(15, 59, Math.toRadians(180));
    public static Pose blue_eat_second_CP = new Pose(45, 58);
    public static Pose blue_open_eat_wait = new Pose();
    public static Pose blue_open_eat = new Pose();
    public static Pose blue_out = new Pose();
