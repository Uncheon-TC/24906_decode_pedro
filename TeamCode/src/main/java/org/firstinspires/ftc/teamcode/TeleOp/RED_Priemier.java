...
@TeleOp(name = "TELEOP_RED_Priemier", group = "2025-2026 Test OP")
public class RED_Priemier extends LinearOpMode {
...
// ===라임라이트 추가=====
        ...
        limelight.pipelineSwitch(0);   // 사용 중인 AprilTag pipeline 번호로 변경
        limelight.start();
//===========================
        ...
        while (opModeIsActive()) { //main loop
            ...
            if (gamepad1.options) {
                ...
                if (result == null) {
                    ...
                    telemetry.addLine("LL RESULT NOT VALID");
                } else {
                    ...
                    if (botpose == null) {
                        ...
                        follower.setPose(new Pose(72+y, 72-x, follower.getHeading()));
                        telemetry.addLine("HARD RESET APPLIED");
                    }
                }
            }
            // ==== 라임라이트 업데이트용==
            ...
            double botHeading_pin = follower.getHeading() + Math.PI;
            ...
            if (gamepad1.right_bumper){
                follower.setPose(new Pose(128,78.5,Math.toRadians(90)));
            }
...
//            }
    ...
    private Pose getLimelightResetPose() {
        ...
        return new Pose(x, y, follower.getHeading());
    }
    //========================================
}
