...
@Autonomous(name = "AUTO_PRE_RED_FAR_60s_A", group = "2026Premiere", preselectTeleOp = "TELEOP_RED_Priemier")
public class PRE_RED_FAR_60s_A extends OpMode {

    private TelemetryManager panelsTelemetry = PanelsTelemetry.INSTANCE.getTelemetry();
    private static final double SHOOTER_POWER_RATIO = 0.69; //속도 오프셋9
